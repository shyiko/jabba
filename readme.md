# jabba ![Latest Version](https://img.shields.io/badge/latest-0.3.0-blue.svg) [![Build Status](https://travis-ci.org/shyiko/jabba.svg?branch=master)](https://travis-ci.org/shyiko/jabba)
